...
def display_stats(stats, stop_event):
...
if __name__ == "__main__":
    ...
    display_thread = threading.Thread(target=display_stats, args=(stats, stop_event))
    ...
    try:
        ...
        stop_event.set()
        time.sleep(1)  # Beri waktu untuk update terakhir
